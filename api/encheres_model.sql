...
ALTER TABLE `Transactions` ADD CONSTRAINT `UserProp` FOREIGN KEY (`User_Id`) REFERENCES `Users` (`id`);
ALTER TABLE `Transactions` ADD CONSTRAINT `Position` FOREIGN KEY (`Position_Id`) REFERENCES `Positions` (`id`);
ALTER TABLE `Users` ADD CONSTRAINT `Wilayas` FOREIGN KEY (`Wilaya_id`) REFERENCES `Wilayas` (`id`);
